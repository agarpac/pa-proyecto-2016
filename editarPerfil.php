    ...
    <section class="bodyRegistro generico2">
        <div class="form-style">
            ...
            <form action="#" method="post">
                ...
                <label><span>Nombre: <span class="required"> * </span></span><input id="nombre" type="text" class="input-field" name="nombre" value="<?php echo $_SESSION['nombre_usuario_login']; ?>" /></label>
                <label><span>1º apell.: <span class="required"> * </span></span><input id="apellido1" type="text" class="input-field" name="apellido1" value="<?php echo $_SESSION['apellido1_usuario_login']; ?>" /></label>
                <label><span>2º apell.: <span class="required"> * </span></span><input id="apellido2" type="text" class="input-field" name="apellido2" value="<?php echo $_SESSION['apellido2_usuario_login']; ?>" /></label>
                <label><span>Email: </span><input id="email" type="email" class="input-field" name="correo" value="<?php echo $_SESSION['correo_usuario_login']; ?>" readonly disabled/></label>
                ...
                <br><input type="submit" class="buttonSpecial" value="Aceptar" name="btnAceptar" />
                <input type="submit" class="buttonSpecial" value="Volver" name="btnVolver" />
                <input type="submit" class="buttonSpecial" value="Eliminar mi cuenta" name="btnEliminar" onclick="return confirmDel()" style="float: right" />
            </form>
        </div>
    </section>
    <?php

...
if (isset($_SESSION['usuario_logueado']) && $_SESSION['usuario_logueado']) {
    ...
    <section class=" bodyRegistro generico">   
        <div class="form-style">
            <div class="form-style-heading">Registro de un nuevo estadio</div>
            <form action="#" method="POST">
                <label><span>Nombre: <span class="required"> * </span></span><input type="text" class="input-field" name="nombre" /></label>
                <label><span>Dirección: <span class="required"> * </span></span><input type="text" class="input-field" name="direccion" /></label>

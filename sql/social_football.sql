...
-- Tiempo de generación: 22-01-2017 a las 21:35:46
...
--
CREATE DATABASE IF NOT EXISTS `social_football` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `social_football`;
...
(29, '¿Qué tal? ¿Te gusta lo que ves?\\r\\n\\r\\n¡Cualquier cosa, avísame!\\r\\n\\r\\nUn saludo.', 'si', 45, 49),
(30, 'Todo bien por ahora, ninguna queja.', 'no', 49, 45),
(31, 'Buenas,\\r\\n\\r\\nesto es un mensaje de prueba!', 'no', 45, 50),
(32, 'Vale, gracias!', 'no', 45, 49),
(33, 'Hola admin,\\r\\n\\r\\nTengo una queja sobre el usuario Pepito.\\r\\n\\r\\nSaludos', 'no', 44, 43);
...
(17, 1, '21/01/2017', 40, 46),
(18, 0, '21/01/2017', 40, 48),
(19, 0, '21/01/2017', 43, 46),
(20, 1, '21/01/2017', 45, 49),
(21, 0, '21/01/2017', 45, 46),
(22, 1, '21/01/2017', 47, 45),
(23, 0, '21/01/2017', 47, 44),
(24, 1, '21/01/2017', 48, 45),
(25, 1, '22/01/2017', 45, 50),
(26, 1, '22/01/2017', 48, 50);
...
(43, 'Admin', 'Admin1', 'Admin2', 'admin@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'userImgs/1484151218admin.png', 'A Coruña', 3, 0),
...
(49, 'dani', 'g', 'g', 'dani@gmail.com', '55b7e8b895d047537e672250dd781555', 'userImgs/1485019009Blitzball.jpg', 'Sevilla', 1, 1),
(50, 'Irene', 'Vargas', 'Manrique', 'irene@gmail.com', '156044609eb527b3b743accc8e7b6d8a', 'userImgs/1485044460Chrysanthemum.jpg', 'Sevilla', 16, 1);
...
--
ALTER TABLE `partido`
  MODIFY `id_partido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
-- AUTO_INCREMENT de la tabla `partido_usuario`
--
ALTER TABLE `partido_usuario`
  MODIFY `id_partido_usuario` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
-- AUTO_INCREMENT de la tabla `peticion_amistad`
--
ALTER TABLE `peticion_amistad`
  MODIFY `id_peticion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
